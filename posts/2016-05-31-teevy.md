...
intro: "Haskell in production: A REST/JSON web service built with aeson, postgresql-simple, scotty and configurator."
author: "mark"
---

Two years ago I joined a few friends who were working on a little hobby project. We were creating a website that allowed you to track the progression of your favorite television series. The project was called [Teevy](https://teevy.co) and is still online, but some parts of it might function a bit strange (no maintenance is done to it lately).
